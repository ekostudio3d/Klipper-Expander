...
klipper expander es una placa MCU Simple para usar con el firmware de la Impresora 3D Klipper con: STM32F042F6P6 MCU con oscilador interno SWD (Serial Wire Debug) header para una fácil depuración 4 3A Mosfet outputs 2 Thermistor inputs 1 Level Shifted Neopixel output 1 GPIO header I2C Header with Pullup Resistors
